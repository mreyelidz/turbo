...
subprocess.run(["docker", "run", "-it", "--rm", "bellsoft/liberica-openjdk-alpine:latest", "java", "-version"])
...
# Run the command to execute the turbo-intruder with basic.py and request.txt
